...
export const SubspaceTemplateSelector: FC<SubspaceTemplateSelectorProps> = ({ name, ...rest }) => {
  ...
  const templateName = useMemo(() => {
    ...
    const defaultPlatformTemplate = t(`context.${ProfileType.Challenge}.template.defaultTemplate`);
  ...
  return (
    <Gutters row alignItems="center" {...rest}>
      <BlockSectionTitle>{t(`context.${ProfileType.Challenge}.template.title`)}</BlockSectionTitle>
